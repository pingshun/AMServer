...
var routes = require('./frontend/routes/index');
var users = require('./frontend/routes/users');
var api = require('./backend/routers/api');
var api_user = require('./backend/routers/api/user');
var ejs = require('ejs');
...
//当程序出错时 NodeJS 应用可能会崩溃。添加上面的代码可以拯救它并且一个错误日志会打到控制台上。
